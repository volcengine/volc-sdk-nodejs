2026-05-14 Bumped to version v1.36.2
...
- rocketmq: 新版实例 topic&group 不拼接命名空间
- 新增 sts 服务
...
- 调整 GetUploadAuth 参数 storeKeys 为非必填项
- 修复 js 项目缺少 tslib 的问题
- 增加点播 sdk
